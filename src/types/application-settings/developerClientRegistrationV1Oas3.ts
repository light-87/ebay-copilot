...
export interface paths {
  '/client/register': {
    ...
    post: DeveloperClientRegistrationOperations['registerClient'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface DeveloperClientRegistrationComponents {
  schemas: {
    ...
    Error: {
      ...
      parameters?: DeveloperClientRegistrationComponents['schemas']['ErrorParameter'][];
...
export interface DeveloperClientRegistrationOperations {
  registerClient: {
    parameters: {
      query?: never;
      header: {
    ...
    requestBody: {
      content: {
        'application/json': DeveloperClientRegistrationComponents['schemas']['ClientSettings'];
      };
    };
    responses: {
      /** @description Created */
      201: {
        ...
        content: {
          'application/json': DeveloperClientRegistrationComponents['schemas']['ClientDetails'];
        };
      };
